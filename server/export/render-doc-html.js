...
// ES 모듈(core/state.js의 DOM 조회에 의존)이라 헤드리스 export 페이지에 그대로 import할 수
// 없으므로, 여기서는 같은 상수를 인라인 <script>로 문자열 삽입한다. 값 자체가 두 곳에서
// 물리적으로 분리된 코드이므로, 문서 Preview의 Mermaid 팔레트를 바꿀 때는 이 값도 함께
// 갱신해야 한다는 점에 주의.
...
module.exports = { buildExportHtmlDocument };
